...
from discord.blueprints import (
...
# the codebase.
from discord.blueprints.guild import (
    guild_roles, guild_members, guild_channels, guild_mod,
    guild_emoji
)

from discord.blueprints.channel import (
    channel_messages, channel_reactions, channel_pins
)

from discord.blueprints.user import (
    user_settings, user_billing, fake_store
)

from discord.blueprints.user.billing_job import (
    payment_job
)

from discord.ratelimits.handler import ratelimit_handler
...
def make_app():
    ...
    app.json_encoder = DiscordJSONEncoder
...
@app.errorhandler(DiscordError)
async def handle_discord_err(err):
    try:
        ejson = err.json
    except IndexError:
        ejson = {}
